...
def engineer_features(df: pd.DataFrame) -> pd.DataFrame:
    df = df.copy()
    # difference between second and first pass pressure
    df["pressure_diff"] = df["secondPassRollPressure"] - df["firstPassRollPressure"]
    # ratio of second to first pass pressure
    df["pressure_ratio"] = df["secondPassRollPressure"] / df["firstPassRollPressure"]
    return df
...
submission_path = "submissions/submission_catboost_eng.csv"
